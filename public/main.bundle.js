...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_12_angular2_flash_messages__["FlashMessagesModule"], __WEBPACK_IMPORTED_MODULE_14__angular_http__["HttpModule"]
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_11__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_13__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]],
...
module.exports = "<div class = 'jumbotron text-center'>\n  <h1>My Profile Page</h1>\n  <p class = 'lead'>This is a small project built on the MEAN stack</p>\n  <div>\n    <a class= \"btn btn-primary\" [routerLink] = \"['/register']\">Register</a> <a class= \"btn btn-default\" [routerLink] = \"['/login']\">Login</a>\n  </div>\n</div>\n<div class='row'>\n  <div class = 'col-md-4'>\n    <h3>Express Backend</h3>\n    <p>This app works on the express server</p>\n  </div>\n  <div class = 'col-md-4'>\n    <h3>Angular-CLI</h3>\n    <p>Angular-CLI to generate components, services and much more...</p>\n  </div>\n  <div class = 'col-md-4'>\n    <h3>JWT Token</h3>\n    <p>Full featured authentication using JSON web token</p>\n  </div>  \n</div>"
    ...
    LoginComponent.prototype.onLogin = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessages.show("You are now logged in!!", { cssClass: "alert-success", timeout: 1500 });
...
var NavbarComponent = (function () {
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        this.flashMessages.show("You are logged out!", { cssClass: 'alert-success', timeout: 1500 });
...
module.exports = "<div *ngIf = \"user\">\n  <h2 class = 'page0-header'>{{ user.name }}</h2>\n  <ul class = 'list-group'>\n    <li class ='list-group-item'>Username : {{user.username }}</li>\n    <li class ='list-group-item'>Email : {{ user.email }}</li>    \n  </ul>\n</div>"
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onSubmit = function (data) {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessages.show("Successfuly Registered ", { cssClass: "alert-success", timeout: 1500 });
                _this.router.navigate(['login']);
            }
            else {
                _this.flashMessages.show("Something went wrong", { cssClass: "alert-danger", timeout: 1500 });
...
var ValidateService = (function () {
    ...
    ValidateService.prototype.validateRegister = function (user) {
        if (user.name == undefined || user.name == undefined || user.email == undefined || user.username == undefined || user.password == undefined) {
            return false;
        }
        else
            return true;
